...
namespace Rolodex.Data.Migrations
{
    ...
    [Migration("20230924174617_0010_FixedNoteCreatedUpdatedHandling")]
    partial class _0010_FixedNoteCreatedUpdatedHandling
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rolodex.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Rolodex.Models.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CategoryContact", b =>
                {
                    b.HasOne("Rolodex.Models.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Rolodex.Models.Contact", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Rolodex.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Rolodex.Models.Category", b =>
                {
                    b.HasOne("Rolodex.Models.AppUser", "AppUser")
                        .WithMany("Categories")
